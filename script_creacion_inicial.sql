...
IF OBJECT_ID('FFAN.AUTO_PARTE', 'U') IS NOT NULL 
DROP TABLE [FFAN].[AUTO_PARTE]
GO

CREATE TABLE [FFAN].[AUTO_PARTE]
(
    AUTO_PARTE_CODIGO DECIMAL(18,0) NOT NULL PRIMARY KEY,
    AUTO_PARTE_DESCRIPCION NVARCHAR(255),
    AUTO_PARTE_FABRICANTE DECIMAL(18,2) NOT NULL FOREIGN KEY REFERENCES FFAN.FABRICANTE(FABRICANTE_ID),
    AUTO_PARTE_MODELO_CODIGO DECIMAL(18,0)
)
...
(
    ITEM_COMPAUTO_NRO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.COMPRA(COMPRA_NRO) PRIMARY KEY,
    ITEM_COMPAUTO_CODAUTO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.AUTO(AUTO_ID) PRIMARY KEY,
    ITEM_COMPAUTO_AUTOMOVIL_PRECIO DECIMAL(18,0)
)
...
(
    ITEM_COMPAUTOPARTE_NRO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.COMPRA(COMPRA_NRO) PRIMARY KEY,
    IITEM_COMPAUTOPARTE_CODAUTOPART DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.AUTO_PARTE(AUTO_PARTE_CODIGO) PRIMARY KEY,
    ITEM_COMPAUTOPARTE_PRECIO DECIMAL(18,0)
    ITEM_COMPAUTOPARTE_CANT DECIMAL(18,0)
)

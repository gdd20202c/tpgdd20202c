...
(
	ITEM_FACTURA_AUTOPARTE_NRO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FACTURA_NUMERO PRIMARY KEY,
    ITEM_FACTURA_AUTOPARTE_CODAUTOPARTE DECIMAL(18,0) NOT NULL FOREIGN KEY AUTOPARTE_CODIGO PRIMARY KEY,
...
(
    ...
    ITEM_FACTURA_AUTOMOVIL_ID DECIMAL(18,0) NOT NULL FOREIGN KEY FFAN.AUTOMOVIL(AUTO_ID) PRIMARY KEY,

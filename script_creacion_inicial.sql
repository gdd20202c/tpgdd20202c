...
(
    ITEM_COMPRA_AUTOMOVIL_ITEM_COMPAUTO_NRO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.COMPRA(COMPRA_NRO) PRIMARY KEY,
    ITEM_COMPRA_AUTOMOVIL_ITEM_COMPAUTO_CODAUTO DECIMAL(18,0) NOT NULL FOREIGN KEY REFERENCES FFAN.AUTO(AUTO_ID) PRIMARY KEY,
    ITEM_COMPRA_AUTOMOVIL_PRECIO DECIMAL(18,0)
)
